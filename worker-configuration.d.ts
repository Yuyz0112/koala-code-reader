/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 54efcd8bfd7c249cc99e3b88d085fa22)
// Runtime types generated with workerd@1.20250508.0 2025-05-22 
declare namespace Cloudflare {
	interface Env {
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		OPENAI_API_KEY: string;
		GITHUB_TOKEN: string;
		FLOW_STORAGE_BUCKET: R2Bucket;
		FLOW_QUEUE: Queue;
	}
}
